<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div @click="changeDefault(address,addressInfo)" v-for="address in addressInfo" class="address clearFix">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul  v-for="(detail,index) in detailArrayList" :key="index" class="list clearFix">
          <li>
