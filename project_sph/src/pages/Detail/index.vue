      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input @change="changeSkuNum" v-model="skuNumber" autocomplete="off" class="itxt">
                <a @click="skuNumber++" href="javascript:" class="plus">+</a>
                <a @click="skuNumber>1?skuNumber--:skuNumber=1" href="javascript:" class="mins">-</a>
              </div>
              <div class="add">
...
<script>
  ...
  export default {
    ...
    methods:{
      changeActive(saleAttrValue,spuSaleAttr){
        console.log(saleAttrValue,spuSaleAttr)
      ...
      async addShopCar(){
        try {
          ...
          this.$router.push({name:"addcartsuccess",query:{skuNum:this.skuNumber}})
        } catch (e) {
